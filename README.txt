...
Through firebase:
	...
	7. You'll be prompt to a Request for Permission. Just select "Allow", then you'll be successfully log in.
...
Access website locally:
	...
	2. Open the unzipped file and double click on index.html